...
const expenseOne = store.dispatch(add_expense({ description: 'Rent', amount: 100, createdAt: -21000 }));
const expenseTwo = store.dispatch(add_expense({ description: 'Coffee', amount: 300, createdAt: 1000 }));
